...
对应实现：\fpath{newdb/engine/src/session/api/session.cpp}、\fpath{newdb/engine/src/c_api/c_api.cpp}、\fpath{newdb/engine/src/schema/schema_io.cpp}、\fpath{newdb/engine/src/error/error_format.cpp}
