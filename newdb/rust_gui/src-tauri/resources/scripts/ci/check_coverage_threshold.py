...
Example:
  ...
  python3 scripts/ci/check_coverage_threshold.py raw.info \\
    --require new/engine/src/:88 --require new/cli/:78
"""
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        help="Substring that must appear in SF paths (e.g. new/engine/src/), minimum line %% hit. Repeatable.",
    )
    ap.add_argument(
        "--include-tests",
        action="store_true",
