...
对应实现：\fpath{newdb/engine/src/mvcc/snapshot/mvcc.cpp}（快照与管理器）、\fpath{newdb/engine/src/io/page/page_io.cpp}（元数据提取）、\fpath{newdb/engine/src/heap/heap_table.cpp}（可见性应用）
